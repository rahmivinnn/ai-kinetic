...
const UserHome = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Today's Overview - Only shown in Overview tab */}
            ...
            <Card className="overflow-hidden border-2 border-primary/10 hover:shadow-lg transition-all duration-300 hover:border-primary/20">
              ...
              <CardContent className="p-6 pt-8">
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" className="w-full" onClick={() => setDashboardNavTab('appointments')}>
                    <Calendar className="h-4 w-4 mr-2" />
                    Schedule
                  </Button>
                </div>
            ...
            <Card className="overflow-hidden border-2 border-primary/10 hover:shadow-lg transition-all duration-300 hover:border-primary/20">
              ...
              <CardContent className="p-6 pt-8">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <Button variant="outline" className="w-full col-span-2" onClick={() => setDashboardNavTab('exercises')}>
